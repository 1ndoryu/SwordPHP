...
function initIconos()
{
    $GLOBALS['iconos'] = [
        ...
        'ver' => '<svg data-testid="geist-icon" height="16" stroke-linejoin="round" style="color:currentColor" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" clip-rule="evenodd" d="M1.5 8C1.5 8 4 4.5 8 4.5C12 4.5 14.5 8 14.5 8C14.5 8 12 11.5 8 11.5C4 11.5 1.5 8 1.5 8ZM8 3C3.5 3 0 8 0 8C0 8 3.5 13 8 13C12.5 13 16 8 16 8C16 8 12.5 3 8 3ZM8 6C6.89543 6 6 6.89543 6 8C6 9.10457 6.89543 10 8 10C9.10457 10 10 9.10457 10 8C10 6.89543 9.10457 6 8 6ZM4.5 8C4.5 6.067 6.067 4.5 8 4.5C9.933 4.5 11.5 6.067 11.5 8C11.5 9.933 9.933 11.5 8 11.5C6.067 11.5 4.5 9.933 4.5 8Z" fill="currentColor"></path></svg>',
